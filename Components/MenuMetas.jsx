...
export default function MenuMetas() {
    ...
    useEffect(() => {
        if (selectedMeta) {
          if (selectedMeta === 'Distancia') {
            navigation.navigate('MetaDistancia');
          } else if (selectedMeta === 'Tiempo') {
            navigation.navigate('MetaTiempo');
          } else if (selectedMeta === 'Pasos') {
            navigation.navigate('MetaPasos');
          }
          setSelectedMeta("");
        }
      }, [selectedMeta, navigation]);
        ...
        <View style={styles.container}>
            ...
            <Image style={styles.cardIcon1} source={require('../assets/MetasHechas.png')} />
                <Picker
                    ...
                    style={styles.picker}
                    onValueChange={(itemValue) => setSelectedMeta(itemValue)}
                >
                    <Picker.Item label="Agregar Meta Perzonalizada" value="" />
                    <Picker.Item label="Meta de distancia" value="Distancia" />
                    <Picker.Item label="Meta de tiempo" value="Tiempo" />
                    <Picker.Item label="Meta de pasos" value="Pasos" />
                </Picker>
                <Ionicons name="menu-sharp" size={24} color="#000" />
            </View>
