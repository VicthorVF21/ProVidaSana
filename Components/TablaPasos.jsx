...
export default function TablaPasos() {
    ...
    useEffect(() => {
        async function fetchMetas () {
            ...
            if (user) {
                ...
                const snapshot = await metasRef.where('TipoMeta', '==', 'Pasos').get();
                if (!snapshot.empty) {
                    ...
                    {metas.map(meta => (
                        <View key={meta.id} style={styles.tableRow}>
                            ...
                            <View style={styles.tableCellActions}>
                                <TouchableOpacity style={styles.editButton} onPress={() => navigation.navigate('EditarMetaP', { meta })}>
