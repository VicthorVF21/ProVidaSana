...
export default function TablaTiempo() {
    ...
    useEffect(() => {
        async function fetchMetas () {
            ...
            if (user) {
                ...
                const snapshot = await metasRef.where('TipoMeta', '==', 'Tiempo').get();
                if (!snapshot.empty) {
                    ...
                    {metas.map(meta => (
                        <View key={meta.id} style={styles.tableRow}>
                            ...
                            <View style={styles.tableCellActions}>
                                <TouchableOpacity style={styles.editButton} onPress={() => navigation.navigate('EditarMetaT', { meta })}>
