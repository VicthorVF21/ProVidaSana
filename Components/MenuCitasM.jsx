...
export default function MenuCitas() {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('ReCitas')} style={styles.TextOptionR1}>
                    <Text>Agendar cita</Text>
                </TouchableOpacity>
                <Ionicons name="menu-sharp" marginLeft={100} size={24} color="#000" />
            </View>
            <View style={styles.ContainerOptions}>
            ...
            <View style={styles.ContainerOptions}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('HistCitas')} style={styles.TextOptionR}>
